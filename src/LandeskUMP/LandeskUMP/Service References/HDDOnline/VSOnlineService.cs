...
namespace LandeskUMP.HDDOnline
{
    public class VSOnlineService
    {
        ...
        private HttpClient GetClient()
        {
            ...
            string username = GetConfigValue("HDDOnline:UserName");
            string password = GetConfigValue("HDDOnline:Password");
        ...
        private void Initialize()
        {
            ...
            string configUrl = GetConfigValue("HDDOnline:Endpoint");
